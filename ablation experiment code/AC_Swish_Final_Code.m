...
% time:20240627
% time:20241216
% Readme: This code is a model experiment code for multimodal models
% 说明：该代码是多模态模型的模型实验代码
clc
clear
...
save('Final_AC_Swish_trained_model.mat', 'net');
%%
%验证测试数据
% 确保网络处于评估模式
net = resetState(net);
...
% accuracy = 0.9386 0.9386 0.9170 0.9314 0.9350 0.9350 0.9278 0.9278 0.9314 0.9386
% time = 4：54
% 参数 = 11.3M 170