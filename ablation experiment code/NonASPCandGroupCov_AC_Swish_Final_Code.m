...
% time:20241216
% Readme: This code is an experiment of the ablation model 
% after eliminating the ASPC module and the depth-separable convolution module 
% from the multimodal model
% 说明：该代码是取消掉多模态模型中ASPC模块和深度可分离卷积模块后的消融模型实验
clc
clear
...
% aspc2 = [
%     convolution2dLayer([3 3],128,'Stride' ,1,'DilationFactor',[1 1],"Name","aspc_conv_2","Padding","same")
...
% 
% aspc3 = [
%     convolution2dLayer([3 3],128,'Stride' ,1,'DilationFactor',[2 2],"Name","aspc_conv_3","Padding","same")
...
save('Final_NonASPCandGroupCov_AC_Swish_trained_model.mat', 'net');
%%
%验证测试数据
% 确保网络处于评估模式
net = resetState(net);
...
% accuracy = 0.8917 0.8773 0.8881 0.8953 0.8917 0.8773 0.8845 0.8664 0.8989 0.8773
% time = 4：43
% 参数 = 8.7M 158