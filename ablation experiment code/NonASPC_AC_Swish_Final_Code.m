...
% after eliminating the ASPC module 
% from the multimodal model
% 说明：该代码是取消掉多模态模型中ASPC模块后的消融模型实验
clc
clear
...
save('Final_NonASPC_AC_Swish_trained_model.mat', 'net');
%%
%验证测试数据
% 确保网络处于评估模式
net = resetState(net);
...
% accuracy = 0.8989 0.9061 0.9061 0.8953 0.8953 0.8917 0.8845 0.9025 0.8989 0.9061
% time = 4：44
% 参数 = 8.7M 160