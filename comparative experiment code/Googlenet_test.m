...
lgraph = disconnectLayers(lgraph,"data","conv1-7x7_s2");
...
lgraph = connectLayers(lgraph,"concat","conv1-7x7_s2");
...
save('trained_model_googlenet.mat', 'net');
%%
%验证测试数据
% 确保网络处于评估模式
net = resetState(net);
...
% accuracy = 0.8736 0.8736 0.8736 0.9097 0.8845 0.8953 0.9170 0.8809 0.9025 0.9097
% 参数 = 5.9M 147