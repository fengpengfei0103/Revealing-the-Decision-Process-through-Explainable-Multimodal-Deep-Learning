...
lgraph = disconnectLayers(lgraph,"ImageInput","efficientnet-b0|model|stem|conv2d|Conv2D");
...
lgraph = connectLayers(lgraph,"concat","efficientnet-b0|model|stem|conv2d|Conv2D");
...
save('trained_model_efficientnetb0.mat', 'net');
%%
%验证测试数据
% 确保网络处于评估模式
net = resetState(net);
...
% accuracy = 0.8700 0.8845 0.8773 0.8700 0.8989 0.8736 0.8700 0.8520 0.8736 0.8484 0.8628 0.8520
% 参数 = 4.0M 293