...
lgraph = disconnectLayers(lgraph,"input_1","conv2d_1");
...
lgraph = connectLayers(lgraph,"concat","conv2d_1");
...
save('trained_model_inceptionv3.mat', 'net');
%%
%验证测试数据
% 确保网络处于评估模式
net = resetState(net);
...
% accuracy = 0.8881 0.9097 0.8736 0.9242 0.8881 0.9061 0.8953 0.9061 0.8881 0.8917 
% 参数 = 21.8M 318