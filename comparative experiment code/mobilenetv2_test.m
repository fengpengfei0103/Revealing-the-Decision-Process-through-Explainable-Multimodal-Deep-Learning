...
lgraph = disconnectLayers(lgraph,"input_1","Conv1");
...
save('trained_model_mobilenetv2.mat', 'net');
%%
%验证测试数据
% 确保网络处于评估模式
net = resetState(net);
...
% accuracy = 0.8159 0.8448 0.8412 0.8520 0.8267 0.8700 0.8448 0.8303 0.8881 0.8484
% 参数 = 2.2M 157