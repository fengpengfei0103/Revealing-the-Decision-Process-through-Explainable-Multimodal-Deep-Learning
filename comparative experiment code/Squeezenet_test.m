...
lgraph = disconnectLayers(lgraph,"data","conv1");
...
save('trained_model_squeezenet.mat', 'net');
%%
%验证测试数据
% 确保网络处于评估模式
net = resetState(net);
...
% accuracy = 0.7473 0.7653 0.7545 0.7798 0.7473 0.7292 0.7617 0.7004 0.7545 0.7365
% time = 03：00
% 参数 = 724.6K 71